<?php get_header(); ?>
			...
			<div class="banner">
				...
				<!-- slideshow start -->
				<!-- ================ -->
				<video class="" preload="none" width="100%" poster='videos/video-poster.jpg' autoplay="auto" loop> 
					<source src='wp-content/themes/jardimdigital/assets/videos/background-video.mp4' type='video/mp4'/>
					<source src='wp-content/themes/jardimdigital/assets/videos/background-video.webm' type='video/webm'/>
				</video>
			...
			<!-- page-top start-->
			<!-- ================ -->
			<div class="page-top gray-bg mais20">
				<div class="container">
					<div class="row">
			...
			<div class="clearfix light-gray-bg object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="200">
				<div class="full-width-section">
					<div class="full-image-container">
						<img class="center-block" src="images/section-image-8.jpg" alt="">
					</div>
				...
				<!-- main start -->
				<!-- ================ -->
				<div class="section  dark-bg pattern-jardim">
					<div class="container">
						<div class="call-to-action">
							<div class="row">
								<div class="col-md-8">
				...
				<div class="full-width-section">
					...
					<div class="full-image-container">
						<img class="center-block" src="images/section-image-9.jpg" alt="">
					</div>
				</div>
			</div>
			<!-- section end -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<h1 class="text-center">Conheça nossas soluções</h1>
			...
			<!-- section start -->
			<!-- ================ -->
			<div class="margin-clear space-top clearfix object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="300">

				<div class="container">
					<!-- page-title start -->
					<!-- ================ -->
					<h1 class="page-title text-center">Portfolio Full Width</h1>
					<div class="separator"></div>
					<br>
					<p class="lead text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas nulla suscipit <br class="hidden-sm hidden-xs"> unde rerum mollitia dolorum.</p>
					<!-- page-title end -->
