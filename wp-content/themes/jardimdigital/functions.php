...
function jd_header_menu() {
  register_nav_menu('header-menu',__( 'Header Menu' ));
}
add_action( 'init', 'jd_header_menu' );

function register_jd_menus() {
  register_nav_menus(
    array(
...
add_action( 'init', 'register_jd_menus' );
...
function add_menu_parent_class( $items ) {
  ...
  foreach ( $items as $item ) {
    if ( in_array( $item->ID, $parents ) ) {
      $item->classes[] = 'dropdown mega-menu dropdown-toggle'; 
    }
  }  
  return $items;    
}

class JD_walker_nav_menu extends Walker_Nav_Menu {

// function pre_lvl () {
//   echo '<ul class="dropdown-menu"><li><div class="row"><div class="col-sm-4 col-md-6"><h4>iDea - Powerful Bootstrap Theme</h4><img src="images/section-image-1.png" alt="image-1"></div><div class="col-sm-8 col-md-6"><h4>Propostas</h4><div class="row"><div class="col-sm-6"><div class="divider"></div>';
// }
